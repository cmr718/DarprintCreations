...
<head>
    ...
    <link rel="stylesheet" href="estiloEliminarProductoConfirmacion.css">
</head>
...
<body>
    ...
    <main class="main">
        <div class="pago">
            <a><strong>PRODUCTO AÑADIDO CORRECTAMENTE</strong></a>
            <img
                    src="http://localhost/TW/imagenes/comprobado.png"
                    alt="Usuario" width="30" height="30" /></a>
        </div>

        <div class="boton">
            <a href="modificarCatalogo.php" class="boton">Ver listado de productos</a>
            <a href="añadirProducto.php" class="boton">Añadir otro producto</a>
        </div>
