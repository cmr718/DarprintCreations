...
<head>
    ...
    <link rel="stylesheet" href="estiloPerProd.css">
</head>
...
<body>
    ...
    <hr>
        ...
        <div class="container">
            <strong><a>PERSONALIZA TU PRODUCTO</a></strong>
        </div>
        <div class="cuerpo">
            <a>
                <p>¿Quieres personalizar algún articulo que no encuentras en nuestra web?</p>
            </a>
            <a>
                <div class="posible">
                    <h2>
            ...
            <div class="descripcion">
                Contacta con nosotros mediante nuestras redes sociales, por nuestro teléfono de contacto o
                visitando nuestra tienda física para establecer los detalles del artículo.    
            </div>
        </div>
