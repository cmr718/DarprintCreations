...
<body>
    ...
    <main class="main">
        <div class="pago">
            <a><strong>¿ESTÁ SEGURO DE QUE DESEA ELIMINAR EL PRODUCTO?</strong></a>
            
        </div>

        <div class="boton">
            <a href="https://localhost/TW/modificarCatalogo.php" class="boton">Volver</a>
            <a href="productoEliminado.php" class="boton">Eliminar producto</a>
        </div>
