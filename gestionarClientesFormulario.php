...
<body>
    ...
    <main class="main">
        ...
        <form action="editarClientes.php?correo=<?php echo $correo?>" method="POST" name="inicio">
            ...
            <label for="text" class="atributosProducto" for="rol">Rol</label>
            ...
            $query_categorias = mysqli_query($mysqli,"SELECT * FROM roles ORDER BY rol ASC");
            ...
            <select name="rol" id="rol">
                ...
                if ($result_categoria > 0) {
                    while ($rol = mysqli_fetch_array($query_categorias)) {
